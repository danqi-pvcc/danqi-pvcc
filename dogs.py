...
#   copying a list od items into another list, and changing the data in the list.
...
def main():
    ...
    print("\nList in reverse alphabnetized order:")
    print(dogs)

    dogs.append("Ranger")
    print("\nAdd a dog to the end od a list:")
    print(dogs)
    ...
    print("Ppo a dog off from position 3(which is the 4th dog) in the list:")
    print(dogs)
    print(another_dog + "was removed form position 3 of the list.")
    ...
    dogs2 = dogs
    print("\nA list can be copied into another list by setting on equal to the other:")
    print(dogs)
    print(dogs2)
